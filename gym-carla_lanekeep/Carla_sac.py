...
def get_args():
    ...
    parser.add_argument("--task", type=str, default="Carla-KeepLane-v3")
...
def test_sac(args=get_args()):
    ...
    path = r"/home/yq/CARLA_0.9.6/CarlaRL/gym-carla_lanekeep/log/Carla-KeepLane-v3/sac/0/221025-174318/checkpoint3.pth"
